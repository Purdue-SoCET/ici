...
void create_bitmap_message_1(Node_Creation_Args* node_creation_arguments, int index, int target, int nodes_found, int hop_bitmap, char* message)
{
    ...
    message[4] = 0x000000FF & node_creation_arguments[index].nodes_connected_to; //what nodes the current node is connected to 
    ...
    message[8] = 0x000000FF & node_creation_arguments[index].nodes_in_fabric; //nodes that present in the model 
